...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class TemporaryPassword : IEquatable<TemporaryPassword>, IValidatableObject
    {
        /// <summary>
        ...
        public TemporaryPassword(string password = default(string))
        {
            ...
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for TemporaryPassword and cannot be null");
            }
