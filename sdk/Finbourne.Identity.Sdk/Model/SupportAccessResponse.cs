...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class SupportAccessResponse : IEquatable<SupportAccessResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public SupportAccessResponse(string id = default(string), string duration = default(string), string description = default(string), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset expiry = default(DateTimeOffset), string createdBy = default(string), bool terminated = default(bool), DateTimeOffset? terminatedAt = default(DateTimeOffset?), string terminatedBy = default(string), List<string> permittedRoles = default(List<string>))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SupportAccessResponse and cannot be null");
            }
            this.Id = id;
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for SupportAccessResponse and cannot be null");
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Duration != null && this.Duration.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Duration, length must be less than 50.", new [] { "Duration" });
            }

            // Duration (string) minLength
            if (this.Duration != null && this.Duration.Length < 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Duration, length must be greater than 3.", new [] { "Duration" });
            }
