...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class LogActor : IEquatable<LogActor>, IValidatableObject
    {
        /// <summary>
        ...
        public LogActor(string id = default(string), string type = default(string), string alternateId = default(string), string displayName = default(string), Dictionary<string, Object> detailEntry = default(Dictionary<string, Object>))
        {
            this.Id = id;
            this.Type = type;
