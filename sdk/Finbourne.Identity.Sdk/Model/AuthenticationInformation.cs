...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class AuthenticationInformation : IEquatable<AuthenticationInformation>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Internal provisioning code.</value>
        ...
        {
            // IssuerUrl (string) minLength
            if (this.IssuerUrl != null && this.IssuerUrl.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IssuerUrl, length must be greater than 1.", new [] { "IssuerUrl" });
            }
