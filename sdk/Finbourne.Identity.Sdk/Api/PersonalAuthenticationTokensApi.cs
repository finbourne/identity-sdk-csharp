...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IPersonalAuthenticationTokensApiSync : IApiAccessor
    {
        ...
        Finbourne.Identity.Sdk.Client.ApiResponse<CreatedApiKey> CreateApiKeyWithHttpInfo(CreateApiKey createApiKey, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Identity.Sdk.Client.ApiResponse<ApiKey> DeleteApiKeyWithHttpInfo(string id, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Identity.Sdk.Client.ApiResponse<List<ApiKey>> ListOwnApiKeysWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IPersonalAuthenticationTokensApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<CreatedApiKey>> CreateApiKeyWithHttpInfoAsync(CreateApiKey createApiKey, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// DeleteApiKey: Invalidate a Personal Access Token
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<ApiKey>> DeleteApiKeyWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// ListOwnApiKeys: Gets the meta data for all of the user&#39;s existing Personal Access Tokens.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<List<ApiKey>>> ListOwnApiKeysWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class PersonalAuthenticationTokensApi : IPersonalAuthenticationTokensApi
    {
        ...
        public Finbourne.Identity.Sdk.Client.ApiResponse<CreatedApiKey> CreateApiKeyWithHttpInfo(CreateApiKey createApiKey, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            localVarRequestOptions.Operation = "PersonalAuthenticationTokensApi.CreateApiKey";
        ...
        public Finbourne.Identity.Sdk.Client.ApiResponse<ApiKey> DeleteApiKeyWithHttpInfo(string id, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            localVarRequestOptions.Operation = "PersonalAuthenticationTokensApi.DeleteApiKey";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Finbourne.Identity.Sdk.Client.ApiResponse<List<ApiKey>> ListOwnApiKeysWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            localVarRequestOptions.Operation = "PersonalAuthenticationTokensApi.ListOwnApiKeys";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<List<ApiKey>>> ListOwnApiKeysWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ApiKey>>("/api/keys", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
