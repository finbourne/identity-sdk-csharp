...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IUsersApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Finbourne.Identity.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="login">The unique login for the User</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="opts">Options for this request.</param>
        /// <returns>UserResponse</returns>
        UserResponse GetUserFromLogin(string login, int operationIndex = 0, ConfigurationOptions? opts = null);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of UserResponse</returns>
        Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse> GetUserFromLoginWithHttpInfo(string login, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
    ...
    public interface IUsersApiAsync : IApiAccessor
    {
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of UserResponse</returns>
        System.Threading.Tasks.Task<UserResponse> GetUserFromLoginAsync(string login, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (UserResponse)</returns>
        System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse>> GetUserFromLoginWithHttpInfoAsync(string login, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EARLY ACCESS] GetUserSchema: Get User Schema
        /// </summary>
        /// <remarks>
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <summary>
        /// GetUserFromLogin: Get User From Login Get the userId of a specified User
        /// </summary>
        /// <exception cref="Finbourne.Identity.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="login">The unique login for the User</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="opts">Options for this request.</param>
        /// <returns>UserResponse</returns>
        public UserResponse GetUserFromLogin(string login, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse> localVarResponse = GetUserFromLoginWithHttpInfo(login, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of UserResponse</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse> GetUserFromLoginWithHttpInfo(string login, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'login' is set
            if (login == null)
            {
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'login' when calling UsersApi->GetUserFromLogin");
            }
            ...
            localVarRequestOptions.PathParameters.Add("login", Finbourne.Identity.Sdk.Client.ClientUtils.ParameterToString(login)); // path parameter

            localVarRequestOptions.Operation = "UsersApi.GetUserFromLogin";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserResponse>("/api/users/fromlogin/{login}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserFromLogin", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of UserResponse</returns>
        public async System.Threading.Tasks.Task<UserResponse> GetUserFromLoginAsync(string login, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse> localVarResponse = await GetUserFromLoginWithHttpInfoAsync(login, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (UserResponse)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<UserResponse>> GetUserFromLoginWithHttpInfoAsync(string login, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'login' is set
            if (login == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserResponse>("/api/users/fromlogin/{login}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
