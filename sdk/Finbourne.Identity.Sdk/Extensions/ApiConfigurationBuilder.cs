    ...
    public class ApiConfigurationBuilder
    {
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-IDENTITY_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-identity_api_url"),
