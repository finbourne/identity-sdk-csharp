...
using System.IO;
using System.Linq;
using SdkConfiguration = Finbourne.Identity.Sdk.Client.Configuration;
...
namespace Finbourne.Identity.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { nameof(ApiConfiguration.BaseUrl), "FBN_IDENTITY_URL" },
        ...
        private static readonly Dictionary<string, string> ConfigNamesToSecrets = new Dictionary<string, string>()
        {
            ...
            { nameof(ApiConfiguration.BaseUrl), "identityUrl" },
        ...
        private static ApiConfiguration BuildFromEnvironmentVariables(ConfigurationOptions? opts)
        {
            ...
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_IDENTITY_URL") ??
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE-IDENTITY_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne-identity_api_url") ?? 
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE_IDENTITY_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne_identity_api_url"),
